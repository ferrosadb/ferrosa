...
- Several named correctness tests are still placeholders in [ferrosa-cluster/tests/correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/tests/correctness.rs): `batch_atomicity_kill_coordinator`, `recovery_coordinator_activation`, `recovery_coordinator_resolves_inflight`, and `pause_resume_state_convergence` all end in `todo!`.
- The storage-side counterparts in [ferrosa-storage/tests/correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/tests/correctness.rs) also leave `dep_wait_ordering_under_partition` and another `batch_atomicity_kill_coordinator` as `todo!`.
- Some tests with spec names exist, but only in the deterministic harness, e.g. `jepsen_full_nemesis_suite` in [ferrosa-cluster/src/accord/jepsen_nemesis.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/src/accord/jepsen_nemesis.rs). That does not satisfy the system-spec requirement for real network, process, and timing behavior.
- The live-cluster nemesis tests in [ferrosa-jepsen/tests/nemesis_correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-jepsen/tests/nemesis_correctness.rs) currently validate inject/heal/reachability, but they do not actually assert the correctness properties named in the spec such as "no phantom commits", "linearizability under packet reorder", or "LWT batch atomicity under all nemeses".
...
- [tests/drivers/docker-compose.drivers.yml](/Users/bkearns/src/ferrosa-suite/ferrosa/tests/drivers/docker-compose.drivers.yml) starts a single Ferrosa node, not a 3-node cluster.
...
- The Python driver test explicitly disables token metadata in [tests/drivers/python/test_cql.py](/Users/bkearns/src/ferrosa-suite/ferrosa/tests/drivers/python/test_cql.py), which means it cannot validate token-aware routing at all.
...
- Unit coverage exists in [ferrosa-storage/src/commitlog/archiver.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/src/commitlog/archiver.rs), [ferrosa-storage/src/snapshot/manager.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/src/snapshot/manager.rs), [ferrosa-storage/src/restore/manager.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/src/restore/manager.rs), and [ferrosa-storage/src/restore/validation.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/src/restore/validation.rs).
...
- The current implementations live in [ferrosa-cluster/src/accord/durability.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/src/accord/durability.rs).
...
- [ferrosa-cluster/src/controller/tests.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/src/controller/tests.rs) covers join approval, progressive join, and bootstrap streaming.
- [tests/docker-smoke.sh](/Users/bkearns/src/ferrosa-suite/ferrosa/tests/docker-smoke.sh) covers useful lifecycle smoke scenarios like add-node, bootstrap, decommission, rebalance, and some FMEA checks.
...
- [ferrosa-cluster/tests/correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/tests/correctness.rs)
- [ferrosa-storage/tests/correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/tests/correctness.rs)
- [ferrosa-jepsen/tests/nemesis_correctness.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-jepsen/tests/nemesis_correctness.rs)
...
- Storage engine basics from `specs/storage.md` are covered well by [ferrosa-storage/tests/integration.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/tests/integration.rs), [ferrosa-storage/tests/engine_integration.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/tests/engine_integration.rs), [ferrosa-storage/tests/pipeline_integration.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/tests/pipeline_integration.rs), and multiple property suites.
- Compaction S3 pipeline coverage is better than the plans imply: [ferrosa-storage/src/engine.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-storage/src/engine.rs) contains tests for output upload, manifest update, input deletion, metrics, Cassandra-readback, and an end-to-end compaction pipeline.
- Accord deterministic Jepsen/register/bank coverage exists in [ferrosa-cluster/tests/jepsen/](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/tests/jepsen/) and [ferrosa-cluster/src/accord/jepsen_bank.rs](/Users/bkearns/src/ferrosa-suite/ferrosa/ferrosa-cluster/src/accord/jepsen_bank.rs), even where live-cluster coverage is still missing.
