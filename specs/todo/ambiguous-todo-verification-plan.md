...
|---|---|---|---|
| Startup smoke test for corrupt SSTables | `specs/implemented/todo-startup-smoke-test-for-corrupt-sstables.md` | Local unit/regression coverage now passes; original live 2026-04-19 data-directory replay remains optional external validation. | Moved to `implemented/` by 2026-07-15 triage. |
