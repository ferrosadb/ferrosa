...
* Try the link:../graph-joins/graph-joins.html[Graph Joins & Traversals] tutorial for a social network variant with fraud detection
* Explore link:../content-personalization/content-personalization.html[Content Personalization] to build a recommendation pipeline
