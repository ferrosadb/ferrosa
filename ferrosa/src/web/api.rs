...
pub async fn get_metrics(
    ...
    // Raft election-storm counter (ferrosa_raft_election_storm_term_jumps_total).
    // The scan-storm regression (t_88223ad0 T0.6) asserts it stays 0 under
    // full-table ALLOW FILTERING load; a non-zero value should alert (P0-17).
